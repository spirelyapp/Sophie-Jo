import { ArrowUpIcon, HeartFilledIcon } from "@radix-ui/react-icons";
    ...
    <footer className="flex font-mono text-xs absolute bottom-0 w-full py-3.5 text-gray-600 border-t border-gray-200 bg-gray-100 md:px-0 px-6">
      <div className="w-full flex justify-between items-center max-w-xl mx-auto">
        <span className="inline-flex items-center gap-1">
          © {new Date().getFullYear()} SOPHIE JO & NOAH{" "}
        ...
        <p className="inline-flex items-center gap-1">
          <HeartFilledIcon className="text-custom" width={12} height={12} /> BY{" "}
          <Link href="https://www.noah.gold" target="_blank" className="underline">
            NOAH
          </Link>
          ®
        </p>
